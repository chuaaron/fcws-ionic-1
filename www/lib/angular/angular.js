    ...
    forEach(modulesToLoad, function(module) {
      ...
      try {
        ...
        if (e.message && e.stack && e.stack.indexOf(e.message) == -1) {
          // Safari & FF's stack traces don't contain error.mailbox content
          // unlike those of Chrome and IE
          // So if stack doesn't contain mailbox, we create a new string that contains both.
...
function qFactory(nextTick, exceptionHandler) {
   ...
   * ```
   *
   * @param {*} reason Constant, mailbox, exception or an object representing the rejection reason.
